...
public class LetterSquare {
    ...
    private boolean isValid(String letter, int wordNum, int charNum) {        
        ...
        if (wordNum == 0 && charNum == 0) {
            ...
            String previousLetter = lastLetter(this.words[wordNum-1]);
            return (letter.equals(previousLetter));
            ...
            if (this.onSameSide(letter, lastLetter(this.words[wordNum]))) {
                ...
                if (dictionary.hasString(this.words[wordNum])) {
