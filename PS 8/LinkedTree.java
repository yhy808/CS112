...
public class LinkedTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("(0) Testing on tree from Coursepack 292");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {26, 12, 32, 4, 18, 38, 7};
            tree.insertKeys(keys);

        LinkedTreeIterator itr = tree.preorderIterator();

        System.out.println("\nfor the tree from Coursepack 292, the preorder is:");
        while (itr.hasNext()) {
        ...
        System.out.println();
        System.out.println("(1) Testing on tree 5, 3, 7, 2, 4, 6, 8");
        try {
            LinkedTree tree = new LinkedTree();
        ...
        System.out.println("\nfor the tree 5, 3, 7, 2, 4, 6, 8, the preorder is:");
        while (itr.hasNext()) {
            System.out.print(itr.next() + " ");
        }
        ...
        System.out.println();
        System.out.println("(2) Testing on tree from Coursepack 292");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {26, 12, 32, 4, 18, 38, 7};
            tree.insertKeys(keys);

        LinkedTreeIterator itr = tree.inorderIterator();

        System.out.println("\nfor the tree from Coursepack 292, the inorder is:");
        while (itr.hasNext()) {
            System.out.print(itr.next() + " ");
        }
        ...
        System.out.println();
        System.out.println("(3) Testing on tree 5, 3, 7, 2, 4, 6, 8");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {5, 3, 7, 2, 4, 6, 8};
            tree.insertKeys(keys);
        ...
        System.out.println("\nfor the tree 5, 3, 7, 2, 4, 6, 8 the inorder is:");
        while (itr.hasNext()) {
            System.out.print(itr.next() + " ");
        }
        ...
        System.out.println();
        System.out.println("(4) Testing on tree from Coursepack 293");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {26, 12, 32, 4, 18, 38, 2, 7, 15, 20};
            tree.insertKeys(keys);

        LinkedTreeIterator itr = tree.inorderIterator();

        System.out.println("\nfor the tree Coursepack 293, the inorder is:");
        while (itr.hasNext()) {
            System.out.print(itr.next() + " ");
        }
        ...
        System.out.println();
        System.out.println("(4) Testing on tree 4, 3, 2, 1");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {4, 3, 2, 1};
            tree.insertKeys(keys);
        ...
        System.out.println("\nfor the tree 4, 3, 2, 1, the inorder is:");
        while (itr.hasNext()) {
            System.out.print(itr.next() + " ");
        }
